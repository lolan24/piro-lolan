...
BOT_TOKEN = environ.get('BOT_TOKEN', '8093995823:AAH3cQZ2JsJlkyOrQ536vncZz_4T8PKzQ88')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7395291646').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7395291646').split()]
...
SUPPORT_CHAT_ID = -1002279935644
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://newfilterbot:HS9bY2pAkrgIm7ig>@cluster0.t5tuy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SandVillage')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002497552838')).split()]
